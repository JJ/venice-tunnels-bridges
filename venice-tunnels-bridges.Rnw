...
Finally, \cite{hershberg_venice_2023} have studied the role of bridges in Venice as a complex network, and how they are used to connect different parts of the city, as well as how they are used to create new connections between different parts of the city. They have also studied the role of bridges in the evolution of the city, and how they contribute to its evolution. This is a very interesting approach that we will try to follow in this paper, although we will focus on the role of bridges and sotoportegos in the network structure of Venice, and how they contribute to its evolution.


\section{Analysis}\label{sec:analysis}

<<statphys.graph.2, echo=FALSE, message=F, fig.height=4, fig.pos="h", fig.cap="Venice street graph. Edge color is red for bridges, blue for underpasses or passages and yellow for everything else.">>=
