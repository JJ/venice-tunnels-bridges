...
\abstract{
<<statphys.abs, echo=FALSE, message=F, fig.height=4, fig.pos="h", fig.cap="Venice footwalk graph. Edge color is red for bridges, blue for underpasses or passages and yellow for everything else.">>=
library(igraph)
